	...
	<?php
		...
		//listing orders
		$orders_arr = $orders->getAllorders();
	?>
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						...
						<form action="../sales/report/complete.php" method="post">
						    &nbsp;&nbsp;&nbsp;<input type="submit" name="exoprt_excel" value="Export All Completed Orders" class="btn btn-success">
						</form>
