...
?>
	...
	<div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Products Category</span>
              <span class="info-box-number"><?php $total_arr = $total->allRecords($packages_category) ?><small>%</small></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">User Enquiry</span>
	...
	<div class="box-body">
		<div class="col-md-6">
			<!-- Chart for product and Category -->
			<div class="box box-danger" style="text-align:center;">
				<div class="box-header with-border">
				  <h3 class="box-title">Product and Product_Category</h3>
				</div>
			
				<div class="box-body">
				  <canvas id="canvas" width=300 height=300></canvas>
				  <ul class="chart-legend clearfix" style="float:left;text-align:justify;">
                    <li><i class="fa fa-circle-o text-red"></i> Products</li>
                    <li><i class="fa fa-circle-o text-green"></i> Product Category</li>
                  </ul>
				</div>
		...
		<div class="col-md-6">
			<div class="box box-danger" style="text-align:center;">
				<div class="box-header with-border" style="text-align:center;">
					<h3 class="box-title">Testimonials, Blog, Facts, Press & Media</h3>
				</div>
				<div class="box-body">
				  <canvas id="canvas1" width=300 height=300></canvas>
				  <ul class="chart-legend clearfix" style="float:left;text-align:justify;">
                    <li><i class="fa fa-circle-o text-red"></i> Testimonials</li>
                    <li><i class="fa fa-circle-o text-green"></i> Facts</li>
                    <li><i class="fa fa-circle-o text-yellow"></i> Press & Media</li>
                    <li><i class="fa fa-circle-o text-aqua"></i> Blogs</li>
                  </ul>
				</div>
			</div>
		</div>
...
var data = [
    {
        value: <?php $total_arr = $total->allRecords($package) ?>,
        color:"#F7464A",
        highlight: "#FF5A5E",
        label: "Red"
    },
    {
        value: <?php $total_arr = $total->allRecords($packages_category) ?>,
        color: "#46BFBD",
        highlight: "#5AD3D1",
        label: "Green"
    },
...
/**  testimonials,facts,blog and press_media  **/

var data = [
    {
        value: <?php $total_arr = $total->allRecords($testimonials) ?>,
        color:"red",
        highlight: "A",
        label: "Testimonials"
    },
    {
        value: <?php $total_arr = $total->allRecords($blog) ?>,
        color: "aqua",
        highlight: "B",
        label: "Blog"
    },
    {
        value: <?php $total_arr = $total->allRecords($press_media) ?>,
        color: "#f39c12",
        highlight: "C",
        label: "Press and Media"
    },
    {
        value: <?php $total_arr = $total->allRecords($facts) ?>,
        color: "green",
        highlight: "D",
        label: "facts"
    },    
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-8">
				  ...
				  <div class="progress-group">
                    ...
                    <div class="progress sm">
                      <div class="progress-bar progress-bar-green" style="width: <?php
								$result= mysql_query("select count(*) from purchase where status = 'Success'");
                  ...
                  <div class="progress-group">
                    <span class="progress-text">Number Of Products</span>
                    <span class="progress-number"><b>100%</b></span>

                    <div class="progress sm">
                      <div class="progress-bar progress-bar-aqua" style="width: <?php
								$result= mysql_query("select count(*) from package");
								$row = mysql_fetch_array($result);
								$total = $row[0];
								echo $total;
							?>%"></div>
                  ...
                  <div class="progress-group">
                    <span class="progress-text">Products Category</span>
                    <span class="progress-number"><b>100%</span>

                    <div class="progress sm">
                      <div class="progress-bar progress-bar-yellow" style="width:<?php
								$result= mysql_query("select count(*) from packages_category");
								$row = mysql_fetch_array($result);
								$total = $row[0];
								echo $total;
							?>%"></div>
				...
				<div class="col-md-4">
					  ...
					  <div class="info-box bg-green">
						...
						<div class="info-box-content">
						  ...
						  <span class="info-box-number">
							<?php
								$result= mysql_query("select count(*) from register where register_type='sales'");
								$row = mysql_fetch_array($result);
								$total = $row[0];
								echo $total;
							?>
					  ...
					  <div class="info-box bg-red">
						...
						<div class="info-box-content">
						  ...
						  <span class="info-box-number">
							<?php
								$result= mysql_query("select count(*) from register where register_type='distributor'");
								$row = mysql_fetch_array($result);
								$total = $row[0];
								echo $total;
							?>
