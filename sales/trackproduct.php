                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="tab-content" style="text-align:center;">
                                                <?php
													...
													if(place == $value){  ?>
														<img src="../assets/img/step1.PNG" alt="Order Placed">
													<?php }
													else if(packing == $value){
														?>
														<img src="../assets/img/step2.PNG" alt="Packing & Pickup">
													<?php
													}else if(shipping == $value){
														?>
														<img src="../assets/img/step3.PNG" alt="Shipping">
													<?php
													}else if(Success == $value){
														?>
														<img src="../assets/img/step4.PNG" alt="Delivered">
													<?php
													}else{
